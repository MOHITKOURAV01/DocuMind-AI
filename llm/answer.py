...
def _build_prompt(query: str, context_chunks: list[dict]) -> str:
    ...
    prompt = f"""You are a helpful AI assistant for DocuMind AI, built by Mohit Kourav. Answer the user's question based ONLY on the provided context documents below.
